    ...
    return (
        <>
            ...
            <div className = "col-12 mb-4">
                ...
                <input type = "text" defaultValue = {transactionID} onChange = {
                    (e) => {
...
export default function ViewHostel(){
        ...
        return photos.map(
            (each, key) => (
                <div key = {key} style = {{
                    ...
                    maxWidth: "150px",
                    maxHeight: "150px",
                    backgroundImage: "url(http://localhost/sally-hostel/images/hostels/" + userData.id + "/" + hostelData.id + "/" + each + ")",
    ...
    React.useEffect(
        () => {
            ...
            fetch(
                "http://localhost:80/sally-hostel/php/processes/HostelOwner/LoadHostelData.php" + search, {
                    method: "POST",
                    headers: {
            ...
            <div className = "pt-4 px-3">
                <div>
                    <div className = "rounded-2x rounded-2x shadow border" style = {{
                        ...
                        backgroundImage: (
                            (hostelData.id)
                            ? "url(http://localhost/sally-hostel/images/hostels/" + userData.id + "/" + hostelData.id + "/" + hostelImages[0] + ")"
                            : ""
                        ),
                        backgroundSize: "cover",
                        backgroundPosition: "center"
                    ...
                    <div className = "py-5">
                        ...
                        <div className = "mt-5">
                            ...
                            } className = "d-none text-capitalize rounded-2x w-100 half-bold text-c  p-3 theme-bg text-white border-0 shadow outline-0">
                                edit hostel data
                            </button>
                        </div>
                    </div>
