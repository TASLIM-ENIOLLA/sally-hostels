...
export default function GetHostelName(){
                    ...
                    <div className = "bg-white overflow-y-auto shadow p-5 rounded-2x w-100" style = {{maxWidth: "480px"}}>
                            ...
                            <div>
                                ...
                                <div className = "flex-h a-i-c mb-4">
                                    ...
                                    <div className = "flex-h flex-1 text-capitalize ml-2 half-bold">
                                        <span className = "flex-1 single-line text-muted">keep it short and catchy</span>
                                    </div>
                                </div>
                                <div className = "flex-h a-i-c mb-4">
                                    <Check />
                                    <div className = "flex-h flex-1 text-capitalize ml-2 half-bold">
                                        <span className = "flex-1 single-line text-muted">be specific</span>
                                    </div>
                                </div>
                                <div className = "flex-h a-i-c mb-4">
                                    <Check />
                                    <div className = "flex-h flex-1 text-capitalize ml-2 half-bold">
                                        <span className = "flex-1 single-line text-muted">avoid abbreviations</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className = "mt-3 text-capitalize text-muted">
                            <input
                                ...
                                onClick = {
                                    (e) => {
                                        window.location = "./get-hostel-location?hostel_name=" + hostelName
                                    }
                                }
                                defaultValue = "Continue"
                                className = {"mt-2 transit half-bold outline-0 border rounded py-2 px-4 theme-bg text-white" + (
                                    (hostelName.length > 0)
                                    ? ""
                                    : " disabled"
                                )} />
