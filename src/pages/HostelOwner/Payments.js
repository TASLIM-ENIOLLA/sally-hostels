...
export default function Payments(){
    ...
    const ReceiptsMKP = () => {
        if(paymentData.length > 0){
            ...
            return (
                <div className = "col-12 p-5 shadow-sm border rounded-2x bg-light text-c text-muted half-bold">
    ...
    React.useEffect(
        () => {
            ...
            fetch(
                "http://localhost:80/sally-hostel/php/processes/HostelOwner/LoadUserReceipts.php" + search, {
                    method: "POST",
                    headers: {
